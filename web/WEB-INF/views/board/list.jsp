                ...
                <div class="col-lg-auto">
                    ...
                    <form id="searchForm" action="/board/list" method="get">
                        ...
                        <div class="form-group"> &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <input type="text"  name="keyword" placeholder="검색" value="<c:out value="${pageMaker.cri.keyword}"/>" />
                        ...
                        <nav aria-label="page navigation ">
                            <ul class="pagination d-flex justify-content-center">
                                ...
                                <c:if test="${pageMaker.next}">
                                    <li class="page-item"> <a class="page-link" href="${root}board/list?pageNum=${pageMaker.endPage + 1}&amount=10&keyword=${pageMaker.cri.keyword}&type=${pageMaker.cri.type}"">Next</a></li>
                                </c:if>
                            </ul>
                        </nav>
                    </div>
